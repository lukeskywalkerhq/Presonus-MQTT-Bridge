...
function getColor(mix: string, mixNumber: number, type: string, typeNumber: number): DeviceConfig[] {
    ...
    const lightDevice: DeviceConfig = {
        ...
        config: {
            ...
            state_topic: `presonus/${mix.toLowerCase()}_${mixNumber}/${type.toLowerCase()}/${typeNumber}/color/state`,
            command_topic: `presonus/${mix.toLowerCase()}_${mixNumber}/${type.toLowerCase()}/${typeNumber}/color/set`,
...
function getSolo(mix: string, mixNumber: number, type: string, typeNumber: number): DeviceConfig[] {
    ...
    const muteDevice: DeviceConfig = {
        ...
        config: {
            name: `${friendlyName}`,
            unique_id: `${baseId}`,
            state_topic: `presonus/${mix.toLowerCase()}_${mixNumber}/${type.toLowerCase()}/${typeNumber}/solo/state`,
            command_topic: `presonus/${mix.toLowerCase()}_${mixNumber}/${type.toLowerCase()}/${typeNumber}/solo/set`,
            availability_topic: `presonus/${mix}`,
            payload_available: "online",
            payload_not_available: "offline",
            payload_on: "Soloed",
...
function getMuteAndFader(mix: string, mixNumber: number, type: string, typeNumber:number): DeviceConfig[] {
    ...
    const muteDevice: DeviceConfig = {
        ...
        config: {
            ...
            state_topic: `presonus/${mix.toLowerCase()}_${mixNumber}/${type.toLowerCase()}/${typeNumber}/mute/state`,
            command_topic: `presonus/${mix.toLowerCase()}_${mixNumber}/${type.toLowerCase()}/${typeNumber}/mute/set`,
            availability_topic: `presonus/${mix}`,
            payload_available: "online",
            payload_not_available: "offline",
            payload_on: "Muted",
    ...
    const faderDevice: DeviceConfig = {
        ...
        config: {
            ...
            state_topic: `presonus/${mix.toLowerCase()}_${mixNumber}/${type.toLowerCase()}/${typeNumber}/level/state`,
            command_topic: `presonus/${mix.toLowerCase()}_${mixNumber}/${type.toLowerCase()}/${typeNumber}/set`,
            availability_topic: `presonus/${mix}`,
            payload_available: "online",
            payload_not_available: "offline",
            min: 0,
